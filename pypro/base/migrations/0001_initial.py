# Generated by Django 3.2 on 2021-04-10 23:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='indica se o usuário pode fazer login neste '
                                                                          'site de administração.',
                                                 verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text='Designa se este usuário deve ser tratado '
                                                                          'como ativo. Desmarque isto em vez de '
                                                                          'deletar contas.', verbose_name='active')),
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for '
                                                                                  'this user.', related_name='user_set', related_query_name='user', to='auth.Permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
